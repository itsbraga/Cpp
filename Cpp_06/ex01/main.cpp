...
/*   Updated: 2025/05/31 18:43:24 by annabrag         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char	**argv)
{
	...
	std::cout << "Pointers equal: " << (pointersEqual ? BOLD PG "✓ YES" : BOLD RED "✗ NO") << RESET << std::endl;
	std::cout << "Data accessible: " << (dataAccessible ? BOLD PG "✓ YES" : BOLD RED "✗ NO") << RESET << std::endl;
	std::cout << "Final status: " << (pointersEqual && dataAccessible ? BOLD PG "SUCCESS" : BOLD RED "FAILURE") << RESET << std::endl;
